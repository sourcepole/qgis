...
FileWriter::FileWriter(QString theFileNameString, FileWriter::FileType theFileFormat)
{
...
const QString FileWriter::fileName()
{
...
void FileWriter::setInputNoData (float theValue)
{
  mInputNoData=theValue;
}

/** Mutator for output no data value */
void FileWriter::setOutputNoData (float theValue)
{
