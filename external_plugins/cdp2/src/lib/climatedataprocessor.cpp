...
ClimateDataProcessor::ClimateDataProcessor(float theNoDataVal)
{
...
float ClimateDataProcessor::meanOverLowestQ(QVector <float> theClimateVector)
{
#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::meanOverLowestQ () called" << std::endl;
    std::cout << "==========================================================" << std::endl;
#endif
...
float ClimateDataProcessor::meanOverHighestQ ( QVector <float> theClimateVector)
{
#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::meanOverHighestQ ( ) called" << std::endl;
    std::cout << "==========================================================" << std::endl;
#endif
...
int ClimateDataProcessor::firstMonthOfLowestQ (QVector <float> theClimateVector)
{
#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::firstMonthOfLowestQ ( float *theClimateVector, int myVectorLengthInt) called" << std::endl;
    std::cout << "==========================================================" << std::endl;
#endif
...
int ClimateDataProcessor::firstMonthOfHighestQ (QVector <float> theClimateVector)
{
#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::firstMonthOfHighestQ ( float *theClimateVector, int myVectorLengthInt) called" << std::endl;
    std::cout << "==========================================================" << std::endl;
#endif
...
float ClimateDataProcessor::meanOverQuarter (QVector <float> theClimateVector, int theStartMonth)
{

#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::meanOverQuarter (float *theClimateVector, int myVectorLengthInt, int theStartMonth) called" << std::endl;
    std::cout << "==========================================================" << std::endl;
#endif
...
float ClimateDataProcessor::lowestValue (QVector <float> theClimateVector)
{

#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::lowestValue ( float *theClimateVector, int myVectorLengthInt) called" << std::endl;
    std::cout << "==========================================================" << std::endl;
#endif
...
in the vector. */
float ClimateDataProcessor::highestValue (QVector <float> theClimateVector)
{

#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::highestValue ( float *theClimateVector, int myVectorLengthInt) called" << std::endl;
    std::cout << "==========================================================" << std::endl;
#endif
...
*/
float ClimateDataProcessor::greatestTotalRange (QVector <float> theClimateVector1,
        QVector <float> theClimateVector2)
{

#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::greatestTotalRange (float *theClimateVector1, int theArrayLength1, float *theClimateVector2, int theArrayLength2) called" << std::endl;
    std::cout << "==========================================================" << std::endl;
#endif
...
float ClimateDataProcessor::greatestMonthlyRange (QVector <float> theClimateVector1,
        QVector <float> theClimateVector2)
{
...
bool ClimateDataProcessor::threshold(QVector <float> &theClimateVector, float theThreshold)
{
    int myVectorLengthInt = theClimateVector.size();
    try
    {
...
float ClimateDataProcessor::threshold(float theFloat, float theThreshold)
{
    try
    {
            if (mNoData==theFloat) 
...
float ClimateDataProcessor::sum(QVector <float> theClimateVector)
{
...
float ClimateDataProcessor::mean (QVector <float> theClimateVector)
{
#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::meanOverYear ( float *theClimateVector, int myVectorLengthInt) called" << std::endl;
    std::cout << "==============================================================" << std::endl;
#endif
...
float ClimateDataProcessor::stddevOverYear (QVector <float> theClimateVector)
{

#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::stddevOverYear ( float *theClimateVector, int myVectorLengthInt) called" << std::endl;
    std::cout << "==============================================================" << std::endl;
#endif
    int myInt=0;
    float myRunningTotFloat=0;
...
int ClimateDataProcessor::monthWithLowestValue(QVector <float> theClimateVector)
{
...
int ClimateDataProcessor::monthWithHighestValue (QVector <float> theClimateVector)
{
...
float ClimateDataProcessor::valueGivenMonth (QVector <float> theClimateVector,int theMonth)
{
...
float ClimateDataProcessor::meanValueOverFrostFreeMonths (QVector<float> theFrostVector,
        QVector <float> theClimateVector)
{
#ifdef QGISDEBUG
    std::cout << "ClimateDataProcessor::meanValueOverFrostFreeMonths (float *theFrostArray, int theFrostArrayLength, float *theClimateVector, int theClimateVectorLength)" << std::endl;
    std::cout << "==============================================================" << std::endl;
#endif
...
int ClimateDataProcessor::numberOfMonthsAboveZero (QVector <float> theClimateVector)
{
